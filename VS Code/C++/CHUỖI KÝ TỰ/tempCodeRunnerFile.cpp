...
int main()
{
    char s[50] = "tRaN DAnG tUan dEP tRai NHAT LUon hEhehe HAHA ";
    char a[100] = "Nay mua dong oi xin hay lam tuyet roi de trang loi em anh ve";
    cout << "So ky tu: " << strlen(a);
    /*cout << "Nhap cai gi di: ";
	cin.getline(s, 50);
    ...
    //ham_ChuyenInHoaInThuong_C_String(s);
    //ham_ChuyenInHoaInThuong_C_String_NEW1(a);
    cout << ham_ChuyenInHoaInThuong_C_String_NEW(a);
