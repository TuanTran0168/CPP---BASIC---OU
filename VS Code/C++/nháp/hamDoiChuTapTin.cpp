...
void ham_DocFile(ifstream docFile, string AdressDoc, string &Data);
void ham_DoiChuVaGhiVaoFile(ofstream ghiFile, ifstream docFile, string AdressGhi, string AdressDoc, string &Data);
...
int main()
{
	...
	ham_DocFile(docFile, AdressDoc, Data);
	ham_DoiChuVaGhiVaoFile(ghiFile, docFile, AdressGhi, AdressDoc, Data);
