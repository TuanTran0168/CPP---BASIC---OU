...
public:
    ...
    void ham_NhapNhieuCanCuoc(CCCD *&ptr, int &n)
    {
    ...
    void ham_NhapNhieuCanCuocString(CCCD *&ptr, int &n)
    {
        cout << "\nBan muon nhap bao nhieu can cuoc cong dan: ";
        cin >> n;
    ...
    void ham_XuatMotCanCuoc(CCCD *ptr, int vitri)
    {
    ...
    void ham_XuatMotCanCuocString(CCCD *ptr, int vitri)
    {
    ...
    void ham_XuatNhieuCanCuoc(CCCD *ptr, int n)
    {
    ...
    void ham_XuatNhieuCanCuocString(CCCD *ptr, int n)
    {
        cout << "\n\tDANH SACH CAN CUOC CONG DAN: ";
        for (int i = 1; i <= n; i++)
        {
    ...
    void ham_SapXepSoCanCuoc(CCCD *ptr, int n)
    {
        for (int i = 1; i <= n; i++)
        {
            for (int j = i + 1; j <= n; j++)
    ...
    void ham_TimCanCuocCoCungMaNgauNhien(CCCD *ptr, int n)
    {
...
int main()
{
    int n;
    CCCD *ptr;
    ptr->ham_NhapNhieuCanCuocString(ptr, n);
    ptr->ham_XuatNhieuCanCuocString(ptr, n);
    ptr->ham_TimCanCuocCoCungMaNgauNhien(ptr, n);
