...
using namespace std;
const int MAX = 4000;
void ham_DocThongTinSinhVienTu_TapTin(int &sl);
void ham_GhiToanBoThongTinSinhVienVao_TapTin(int sl);
...
int main()
{
    ...
    ham_DocThongTinSinhVienTu_TapTin(sl);
    //ham_GhiToanBoThongTinSinhVienVao_TapTin(sl);
    ...
    do
    {
        ...
        if (luachon == 1)
        {
            ...
            /*if (MHhayTT == 1)
            {
                ham_InRaDanhSachSinhVienTheoThang_ManHinh(sl);
            }
            if (MHhayTT == 2)
                ham_InRaDanhSachSinhVienTheoThang_TapTin(sl);*/
        ...
        if (luachon == 2)
        {
            ham_ManHinhHayTapTin(MHhayTT);
            /*if (MHhayTT == 1)
                ham_InRaTenTheoChuCaiNhapVao_ManHinh(sl);
            if (MHhayTT == 2)
                ham_InRaTenTheoChuCaiNhapVao_TapTin(sl);*/
        ...
        if (luachon == 3)
        {
            ham_ManHinhHayTapTin(MHhayTT);
            /*if (MHhayTT == 1)
                ham_InRaDanhSachSinhVienTheoMSSV_ManHinh(sl);
            if (MHhayTT == 2)
                ham_InRaDanhSachSinhVienTheoMSSV_TapTin(sl);*/
